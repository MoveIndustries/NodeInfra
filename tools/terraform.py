...
class TerraformManager:
    ...
    def plan(self, var_args: Optional[List[str]] = None, out_file: Optional[Path] = None) -> None:
        """
        Run Terraform plan.
    ...
    def apply(
        self,
        var_args: Optional[List[str]] = None,
    ...
    def destroy(self, var_args: Optional[List[str]] = None, auto_approve: bool = True) -> None:
        """
    ...
    def get_output(self, key: str, raw: bool = False) -> Optional[str]:
        """
